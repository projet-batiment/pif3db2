...
import fr.insa.toto.webui.MatchsEditorOld;
...
public class TournoisMatchsOld extends VerticalLayout implements BeforeEnterObserver {
    ...
    public TournoisMatchsOld() {
        bNew = new Button("Nouveau...");

        var matchsEditor = new MatchsEditorOld();

 ...
 * @author elio
 */
@Route(value = "tournois/match", layout = TournoisLayout.class)
public class TournoisMatchs extends ParentMatchs implements BeforeEnterObserver {
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (id == null) {
            Session.addErrorMessage("TournoisMatchs: pas d'ID de tournois en mémoire");
